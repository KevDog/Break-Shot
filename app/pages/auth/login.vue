<template>
  <main class="auth-page">
    <div class="auth-card">
      <h1 class="auth-card__title">{{ $t('app.name') }}</h1>
      <p class="auth-card__subtitle">{{ $t('auth.signInToContinue') }}</p>
      ...
      <!-- Email login form -->
      <form class="auth-form" @submit.prevent="signInWithEmail">
      ...
      <div class="auth-card__links">
        <NuxtLink to="/auth/signup" class="auth-card__link">
          {{ $t('auth.noAccount') }}
        </NuxtLink>
        <NuxtLink to="/auth/forgot-password" class="auth-card__link">
...
async function signInWithEmail() {
  ...
  if (authError) {
    ...
    // Redirect handled by Supabase module
    navigateTo('/')
  }
}
